...
export default class AxiosFun extends Vue {
  ...
  public static websocketProtocol = "ws://";
  ...
  public static monitorCenterHttpBaseUrl = AxiosFun.httpProtocol + AxiosFun.monitorCenterHostAddress + AxiosFun.monitorCenterServiceName;
  ...
  public apiAxios(method: string, url: string, params: any): Promise<any> {
    return new Promise((resolve, reject) => {
      ...
      if (
        "/dfas-monitor-center/api/web/login" !== url &&
