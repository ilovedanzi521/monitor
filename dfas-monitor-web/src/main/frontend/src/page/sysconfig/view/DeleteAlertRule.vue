<template>
  <win-fdialog title="删除预警规则配置" :visible.sync="dialogFormVisible" @close="close" :close-on-click-modal="false" width="800px" noDrag>
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="_deleteAlertRule('scrape')">确 认</el-button>
    </div>
  </win-fdialog>
</template>
...
<script lang="ts">
  ...
  @Component({})
  export default class DeleteAlertRule extends BaseController {
    ...
    _deleteAlertRule(formName) {
      ...
      console.log("_deleteAlertRule>>>>>start");
      console.log(this.userReqVo);
      console.log("_deleteAlertRule>>>>>end");

      this.$emit("deleteAlertRule", comParams,this.userReqVo);
    }
